...
import com.acquirerx.backend.merchant.dto.MerchantKYCRequestDTO;
import com.acquirerx.backend.merchant.dto.MerchantKYCResponseDTO;
import com.acquirerx.backend.merchant.dto.PricingModelRequestDTO;
import com.acquirerx.backend.merchant.dto.PricingModelResponseDTO;
import com.acquirerx.backend.merchant.dto.SettlementProfileRequestDTO;
import com.acquirerx.backend.merchant.dto.SettlementProfileResponseDTO;
import com.acquirerx.backend.merchant.service.MerchantOnboardingService;
...
public class MerchantOnboardingController {
    ...
    @PutMapping("/settlement-profile/{profileId}")
    ...
    @PatchMapping("/settlement-profile/{profileId}/deactivate")
    ...
    @GetMapping("/settlement-profile/merchant/{merchantId}")
    ...
    @PatchMapping("/pricing/{pricingId}/deactivate")
    ...
    @GetMapping("/pricing/merchant/{merchantId}")
