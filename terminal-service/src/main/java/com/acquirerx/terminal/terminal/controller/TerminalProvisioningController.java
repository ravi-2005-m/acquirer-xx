...
import com.acquirerx.terminal.terminal.service.TerminalProvisioningService;
...
public class TerminalProvisioningController {
    ...
    @PutMapping("/profiles/{profileId:\\d+}")
    ...
    @PatchMapping("/profiles/{profileId:\\d+}/deactivate")
    ...
    @PostMapping("/profiles/{profileId:\\d+}/assign/{terminalId:\\d+}")
    ...
    @PostMapping("/health/{terminalId:\\d+}")
    ...
    @GetMapping("/health/{terminalId:\\d+}")
